...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--out-dir', type=str, default='./dmtet_results111')
    ...
    mtl_default = {
        ...
        # 'kd'   : texture.Texture2D(torch.randn((64, 64, 3), device='cuda', dtype=torch.float32), trainable=True),
